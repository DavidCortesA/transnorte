  ...
  return (
    <section className="bg-red-700 py-16 lg:py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <InView>
          <h2 className="text-3xl sm:text-4xl font-black text-white mb-4">{service.ctaTitle}</h2>
          <p className="text-red-200 leading-relaxed mb-8 max-w-xl mx-auto">{service.ctaSubtitle}</p>
